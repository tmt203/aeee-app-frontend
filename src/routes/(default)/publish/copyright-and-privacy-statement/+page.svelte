...
<svelte:head>
	<title>Copyright and Privacy Statement - AEEE</title>
	<meta name="description" content="Copyright and privacy statement for the journal." />
</svelte:head>

<DefaultPageLayout breadcrumbs={["About Us", "Copyright and Privacy Statement"]}>
	{#if page}
		<div class="flex w-full flex-col gap-4 xl:w-9/12">
			...
			<div class="flex w-full justify-end text-sm text-gray-600 dark:text-gray-400">
				<span>
					Last updated: {parseToFormat(page.updated_at, "yyyy/MM/dd HH:mm:ss")}
				</span>
			</div>
		</div>
	{:else}
